...
const dict = {
  ...
  zh: {
    ...
    safetyTitle: "安全检查",
    safetyLead: "通过实时 RPC 证据检查任意 X Layer 地址，并在适用时添加付费代币或交易前启发式分析。",
    safetyNetwork: "仅限 X Layer · Chain 196",
    safetyMethod: "实时 RPC 证据 + 明确分离的启发式分析",
    safetyRpc: "免费检查直接读取 X Layer RPC。付费评分仍是确定性启发式分析，并非审计或交易模拟。",
    contractInspect: "在 X Layer 检查合约 · 免费",
    contractAddressTip: "任意 X Layer EVM 地址。免费检查返回实时 RPC 事实；付费代币风险另行提供启发式评分。",
    tokenScan: "代币风险 · $0.01",
