...
const dict = {
  en: {
    ...
    base: "Base analysis · $0.03",
    baseTip: "Your connected wallet pays $0.03 USDT0 via x402, then Grok analyzes OKX OHLCV.",
    premium: "Premium analysis · $0.06",
    premiumTip: "Your wallet pays $0.06. Deeper multi-scenario targets and agent checklist.",
  ...
  zh: {
    ...
    base: "基础分析 · $0.03",
    baseTip: "连接的钱包通过 x402 支付 $0.03，然后 Grok 分析欧易 OHLCV。",
    premium: "高级分析 · $0.06",
    premiumTip: "钱包支付 $0.06。多情景目标与智能体清单。",
    connect: "连接钱包",
    walletFunding: "钱包与充值",
