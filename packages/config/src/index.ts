...
const EnvSchema = z.object({
  ...
  GROK_AUTOPILOT_MODEL: z.string().optional().default("grok-4.5"),
  ...
  GROK_MAX_INPUT_AUTOPILOT: z.coerce.number().int().min(4000).max(128000).default(48000),
  GROK_MAX_OUTPUT_AUTOPILOT: z.coerce.number().int().min(256).max(8192).default(2000),
