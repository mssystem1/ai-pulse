...
Browser prices live in `apps/web/src/balances.ts`: Global/Prediction Base $0.20, Global/Prediction Premium $0.30, and Token Risk Guard $0.20. The browser guard is UX protection; seller middleware and the facilitator remain authoritative.
